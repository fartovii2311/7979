...
if (!fs.existsSync(`./ВАРЕЖКА/${conn.user.jid.split`@`[0]}/creds.json`)) {
...
const path = conn.user.jid != global.conn.user.jid ? `./ВАРЕЖКА/${conn.user.jid.split`@`[0]}/creds.json` : `./GataBotSession/creds.json`
